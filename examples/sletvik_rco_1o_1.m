...
object_ranges =  [5:1:110]; ms = length( object_ranges );
object_depths = [2:0.5:24]; ns = length( object_depths );
...
thetamax = 30; np2 = 101; la = linspace(-thetamax,thetamax,np2);
