%==================================================================
% 
% cTraceo - Munk Profile, Deep Water, Eigenray Search by Proximity
% 
...
case_title = '''Munk Profile, Deep Water, Eigenray Search by Proximity''';
...
for h = 1:length(ranges)  %iterate over hydrophones
    for i = 1:eigenrays(h).nEigenrays   %iterate over eigenrays of hydrophone
...
xlabel('Range (m)')
ylabel('Depth (m)')
title('TRACEO - Munk profile, Eigenrays by proximity')
axis([0 Rmax 0 Dmax])
view(0,-90)
hold off
